...
Aplikace využívá webového rozhraní geolokace pro získání aktuální polohy uživatele. Proces zahrnuje požádání uživatele polohu využít (viz obr.\ref{geolokace})
...
Zajímavou funkcí pro dopravce je monitorování návštěvnosti aplikace za~pomocí Google Analytics. Za běhu aplikace jsou při různých událostech (např. návštěva stránky) odesílány informace o době návševy uživatele do monitovacího panelu. \cite{googleanalytics}
