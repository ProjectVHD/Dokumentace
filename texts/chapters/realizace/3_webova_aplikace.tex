...
Webová aplikace využívá technologie NextJS pro statické generování aplikace na~straně serveru (pro podporu SEO). Webová aplikace využívá za~svého chodu spoustu doplňujících dotazů přes internet pro~dosažení interaktivity, takzvaných XHR requestů.
...
\subsection{Provozní upozornění} Dopravci mohou přidávat do~aplikace klienta provozní upozornění, které se~zobrazí v~případě, že se~vyskytne nějaká situace, která může mít vliv na~cestu cestujícího.\par Za~tímto účelem vzniklo uživatelské prostředí pro dispečink dopravce.
